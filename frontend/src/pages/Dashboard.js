...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen page-bg">
      {/* Navigation Header */}
      <nav className="relative bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700 text-white sticky top-0 z-10 backdrop-blur border-b border-transparent">
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-pink-500 to-purple-500 text-white px-4 py-2 rounded-lg text-sm font-medium hover:opacity-90 transition duration-150 ease-in-out"
              >
                Logout
              </button>
            </div>
