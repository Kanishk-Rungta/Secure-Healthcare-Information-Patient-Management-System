    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <main className="p-8 max-w-7xl mx-auto space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
            <p className="text-sm font-bold text-slate-500 uppercase">Registered Patients</p>
            <p className="text-3xl font-black text-blue-600 mt-1">{stats?.totalPatients || 0}</p>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
            <p className="text-sm font-bold text-slate-500 uppercase">Medical Records</p>
            <p className="text-3xl font-black text-emerald-600 mt-1">{stats?.totalRecords || 0}</p>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
