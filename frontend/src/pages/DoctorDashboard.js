...
const DoctorDashboard = () => {
  return (
    <div className="px-4 py-6 sm:px-0">
      <div className="bg-blue-50 border border-blue-200 rounded-2xl shadow-sm p-6 mb-6">
        <h1 className="text-2xl font-semibold text-slate-900">Doctor Overview</h1>
        <p className="text-sm text-slate-600 mt-1">Manage your appointments, patients, and tasks.</p>
        <div className="mt-4 flex flex-wrap gap-2">
          <button className="px-4 py-2 rounded-lg bg-blue-700 text-white text-sm font-medium hover:bg-blue-800">Start Rounds</button>
          <button className="px-4 py-2 rounded-lg border border-blue-200 text-sm font-medium text-blue-800 hover:bg-blue-50">Write Notes</button>
          <button className="px-4 py-2 rounded-lg border border-blue-200 text-sm font-medium text-blue-800 hover:bg-blue-50">New Prescription</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
        {[
          ...
          <div key={card.label} className="bg-white border border-blue-200 rounded-xl p-5 shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white border border-blue-200 rounded-2xl shadow-sm">
          <div className="px-6 py-5 border-b border-blue-100 flex items-center justify-between">
            ...
            <span className="text-sm text-slate-600">9 scheduled</span>
          </div>
        ...
        <div className="bg-white border border-blue-200 rounded-2xl shadow-sm">
