            ...
            <form className="space-y-6 mt-8" onSubmit={handleVerifyOTP}>
              <div className="text-center mb-4">
                <p className="text-sm text-gray-600">
                  Please enter the 6-digit code sent to <strong>{formData.email}</strong>
                </p>
              </div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="000000"
                  className="block w-full px-4 py-3 text-center text-2xl tracking-widest border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center px-6 py-2.5 rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition"
                >
